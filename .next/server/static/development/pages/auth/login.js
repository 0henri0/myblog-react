...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return apiLogin; });
/* harmony import */ var _utils_Http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/Http */ "./utils/Http.js");

function apiLogin(data) {
  return new _utils_Http__WEBPACK_IMPORTED_MODULE_0__["default"]().post('/login', data);
}
...
const Login = ({
  ...
  const handleInputChange = e => {
    ...
    setState(state => Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state, {
      [name]: value
    }));
  };
...
class Login extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  constructor(...args) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "handleCheckLogin", credentials => {
      const {
        email,
        password
      } = credentials;
      Object(_api_auth__WEBPACK_IMPORTED_MODULE_4__["default"])({
        'email': email,
        'password': password
      }).then(response => {
        console.log('success');
  ...
  render() {
    return __jsx(_components_layouts_layout__WEBPACK_IMPORTED_MODULE_1__["default"], {
      ...
      credentials: this.handleCheckLogin
    }));
  }
...
module.exports = __webpack_require__(/*! /media/thai/CC064FEE064FD7DA/React/myblog-react/pages/auth/login.js */"./pages/auth/login.js");
