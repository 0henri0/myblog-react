...
// CONCATENATED MODULE: ./modules/home/types.js
const FETCH_MOMENT = 'FETCH_MOMENT';
// CONCATENATED MODULE: ./modules/home/reducers.js


const initinalState = {
  item: []
};
/* harmony default export */ var reducers = (function (state = initinalState, action) {
  switch (action.type) {
    case FETCH_MOMENT:
...
const initsStore = initialState => Object(external_redux_["createStore"])(reducer, initialState, Object(external_redux_devtools_extension_["composeWithDevTools"])());

/* harmony default export */ var redux_store = (initsStore);
